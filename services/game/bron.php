...
function sendCorpMail($data){
	...
	$headers .= 'From: =?utf-8?B?'.base64_encode('Корпоративные игры «Эмоциональный интеллект»').'?= <info@systemice.ru>' . "\r\n";
	$headers .= 'Reply-To: =?utf-8?B?'.base64_encode('Корпоративные игры «Эмоциональный интеллект»').'?= <info@systemice.ru>' . "\r\n";
	...
	$text .= 'С сайта Корпоративные игры «Эмоциональный интеллект»';
