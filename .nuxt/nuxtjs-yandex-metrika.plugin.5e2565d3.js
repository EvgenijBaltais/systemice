export default (ctx, inject) => {
  ...
  function create() {
    window['yaCounter24221908'] = new Ya.Metrika( {"id":"24221908","webvisor":true,"clickmap":true,"trackLinks":true,"accurateTrackBounce":true} )
    ...
    ctx.app.router.afterEach((to, from) => {
      ...
      window['yaCounter24221908'].hit(to.fullPath, {
    ...
    inject('metrika', window['yaCounter24221908'])
  }
