...
export const state = () => ({
    ...
    portfolioData: [{
    	...
    	spectators: '',
    	details: [`Для размещения группы в 550 человек был выбран отель Рэдиссон Завидово.
         Были выбраны локации на территории отеля и на пляже рядом. Были застроены 2 сцены, 
         одна на первый вечер мероприятия, вторая - основная - на второй. Накануне мероприятия
          был осуществлена выдача welcome-подарков для участников мероприятия. 
          Для проведения мероприятия были приглашены подрядчики по организации активностей на земле и воде,
           VR-комната, привезены аппараты с мороженым, с кукурузой и сладкой ватой. 
           Зона фестиваля была ограждена фан-барьерами, периметр был огорожен постами охраны, 
           на территорию пропускали только участников с браслетами фестиваля. 
           На воде дежурили спасатели, а реанимация сопровождала мероприятие 24/7.
            В первый день фестиваля гостям предлагали разливное крафтовое пиво, легкие алкогольные коктейли, линии с уличной едой. Гостей развлекала известная кавер-группа и ведущий.
        Во второй день фестиваля работали различные зоны развлечений в течении всего дня. 
        Хедлайнером фестиваля выступила группа Little Big, а вечер закрывал праздничный салют.`]},
		{
    	title: 'Nexters Global',
    	...
    	spectators: '',
    	details: [`После инспекции ряда площадок в Москве и ближайшем Подмосковье было принято решение организовать импровизированную
         студию в офисе заказчика. Был выбран и предложен подрядчик, который отвечал за техническую часть - завоз 
         необходимого оборудования, подготовка и написание веб-страницы мероприятия, доступной только для сотрудинков
          компании (вход по логину-паролю), застройка студии и связь ее с передвижной студией в помещении кулинарной мастерской. 
          Одной из частей мероприятия был кулинарный мастер-класс со звездным ведущим - Константином Ивлевым. Под эту часть корпоратива
           участникам мероприятия были доставлены продукты для приготовления традиционных новогодних блюд. В основной студии в офисе
            заказчика был подготовлен сценарий мероприятия в формате "Вечернего Урганта". Так же было отведено отдельное помещение 
            под кейтеринг, где приглашенные подрядчики готовили блюда для звезд вечера, исходя из их бытового райдера. Написанием сценария
             вечера занимались профессиональные сценаристы, работающие с Первым каналом. Во время вечерней части мероприятия гостям развозили
              новогодние подарки силами службы "Дед-мороз на дом". Участники имели возможность писать в прямой эфир, некоторые их вопросы и 
              комментарии зачитывали ведущие с Первого канала, также был осуществлен выход участников из разных точек России в прямой эфир. 
              Закончился вечер розыгрышем главного приза - PS5 и музыкальной программой от группы "Фрукты"`]},
		{
    	title: 'NSP',
    	...
    	spectators: '',
    	details: [`Для размещения группы были выбраны 2 отеля Будапешта, так как один отель не мог принять всю группу сразу. 
        ...
        На следующий день был организован выезд во всемирноизвестные термальные источники Сечень - для этого баня была выкуплена под закрытие под наших участников. Оттуда гостей на нескольких автобусах вывезли в ресторан национальной кухни на обед, который так же был выкуплен для нашей группы.`]},
		{
    	title: 'NSP',
    	...
    	spectators: '',
    	details: [` Для размещения группы был выбран отель 5*, работающий по системе Ultra all-inclusive,
             ...
             турецкие сувениры - рахат-лукум и фески. За 2 дня конференции были подведены итоги прошедшего финансового года,
              награждены лучшие сотрудники, опробованы в игровом формате новые методики и способы увеличения уровня продаж.
               Торжественная часть в офисе включала в себя приветственное шампанское, речь владельцев компании и символическое
                разрезание красной ленты, означающее открытие филиала в Анталье. `]},
   		{
    	...
    	spectators: '',
    	details: [` Для размещения группы был выбран один из лучших отелей Казани - Казанская Ривьера. 
        Накануне мероприятия была осуществлен выдача welcome-подарков для участников мероприятия.
         ...
         различных творческих мастер-классах. После их ждал обед, во время которого выступали фольклорные
          исполнители: музыканты, певцы, танцоры. Гости могли принять участие в различных интерактивных номерах
           и примерить на себя национальные костюмы. 
        На следующий день, после проведения конференции, программа мероприятия завершалась торжественным гала-ужином 
        с приглашенным ведущим из Москвы - Александром Касаткиным, актером театра и кино. Тематический вечер в стиле 
        кругосветного путешествия включал в себя также и  заранее подготовленные выступления участникаов из разных регионов
         РФ и позволял гостям необычно и интереснее всего презентовать свой регион.`]},
