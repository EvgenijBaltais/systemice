		...
		<div class="main">
			...
			<div class="content-main" id = "portfolio-box">
				<div class="slider content-slide scrolling-box" id = "portfolio-slider">
						<div class="sl-card sl-box-1"style="background-image: url('@/assets/images/conf1.jpg')"><a href="portfolio1.php">
							<div class="bg-hover">
						...
						<div class="sl-card sl-box-2" style="background-image: url('@/assets/images/conf.jpg')">
							<div class="bg-hover">
								<div class="event-info">
