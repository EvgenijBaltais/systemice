...
export const state = () => ({
    ...
    },
    {
        ...
        стратегическую ссесию с участием руководителей компании 
...

    {
        ...
        техничесоке обеспечение мероприятия. Составить полный сценрий мероприятия.`
    },
    ...
    },
    {
        ...
        details: `
        <ul>
            <li>index.jsДве оборудованные студии</li>
            <li>Полное техническое сопровождение</li>
