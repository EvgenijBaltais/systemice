...
if ($(window).width() >= 480) {
		...
		if ($.cookie('dont_show_chat') == 1) {
			...
			if (autoOpen) {
				...
				setTimeout(function(){
					...
					ym(53235316, 'reachGoal', 'chat_fadein');
	...
	setTimeout(function(){
		...
		if ($('#dialog').is(':hidden')) {
			...
			ym(53235316, 'reachGoal', 'get_game_click');
	...
	if ($.cookie('closed_chat') == 1 && $.cookie('dont_show_chat') == 1){
		...
		if (autoOpen) {
			...
			setTimeout(function(){
				...
				ym(53235316, 'reachGoal', 'chat_fadein_mobile');
...
function goToChat(formTypeId, dopinfo) {
			...
			if (formTypeId == 'get_game_1') {
				...
				ym(53235316, 'reachGoal', 'get_game_1');
			}

			if (formTypeId == 'get_game_2') {

				ym(53235316, 'reachGoal', 'get_game_2');
			}

			if (formTypeId == 'get_game_3') {

				ym(53235316, 'reachGoal', 'get_game_3');
			}

			if (formTypeId == 'get_game_4') {

				ym(53235316, 'reachGoal', 'get_game_4');
			}
...
function resetCookie() {
	...
	$('#dialog-close').on('click', function(){
		...
		if ($(window).width() < 480) {
			...
			body_unlock();
			ym(53235316, 'reachGoal', 'close_manager_chat_mobile');
		}

		else {

			ym(53235316, 'reachGoal', 'close_manager_chat');
		}
	...
	if ($(window).width() > 480) {
		...
		ym(53235316, 'reachGoal', 'get_chat_click');

	}

	else {

		ym(53235316, 'reachGoal', 'get_chat_click_mobile');
	}
	...
	$('#dialog-datepicker').datepicker({
	    ...
	    $('#step-3').fadeIn(phraseSpeed);
			...
			ym(53235316, 'reachGoal', 'get_game_1_1');

			ym(53235316, 'reachGoal', 'get_game_2_1');

			ym(53235316, 'reachGoal', 'get_game_3_1');

			ym(53235316, 'reachGoal', 'get_game_4_1');

			ym(53235316, 'reachGoal', 'get_game_click_1');
	...
	$('.number-button').on('click', function(){
		...
		isActive($(this));
			...
			ym(53235316, 'reachGoal', 'get_game_1_2');

			ym(53235316, 'reachGoal', 'get_game_2_2');

			ym(53235316, 'reachGoal', 'get_game_3_2');

			ym(53235316, 'reachGoal', 'get_game_4_2');

			ym(53235316, 'reachGoal', 'get_game_click_2');
	...
	$('.answer-button').on('click', function(){
		...
		$('#whatsapp-button-onclick').attr('href', text);
			...
			ym(53235316, 'reachGoal', 'get_game_1_3');

			ym(53235316, 'reachGoal', 'get_game_2_3');

			ym(53235316, 'reachGoal', 'get_game_3_3');

			ym(53235316, 'reachGoal', 'get_game_4_3');

			ym(53235316, 'reachGoal', 'get_game_click_3');
	...
	$('#whatsapp-button-onclick').on('click', function() {
		...
		gtag('event', 'send_form_dialog_corp', {'event_category': 'send_form_dialog_corp_'});
			...
			ym(53235316, 'reachGoal', 'get_game_1_4');

			ym(53235316, 'reachGoal', 'get_game_2_4');

			ym(53235316, 'reachGoal', 'get_game_3_4');

			ym(53235316, 'reachGoal', 'get_game_4_4');

			ym(53235316, 'reachGoal', 'get_game_click_4');


			ym(53235316, 'reachGoal', 'send_form_dialog_corp');

			ym(53235316, 'reachGoal', 'click_whatsapp');
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		//if(yaCounter53235316) { yaCounter53235316.reachGoal('send_request'); yaCounter53235316.reachGoal('goal_allgoal_0');}
		var $this = $(this);
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игра «Порт мечты» (systemice.ru/port_mechty); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
